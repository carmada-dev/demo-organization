...
output OrganizationContext object = deployDevCenter.outputs.OrganizationContext
output ProjectContext array = [ for i in range(0, length(ProjectDefinitions)) : deployDevProject[i].outputs.ProjectContext ]
